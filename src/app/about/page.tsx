...
/**
 * Halaman Informasi Aplikasi (About Page)
 * Berisi deskripsi singkat tentang CardToo, logo aplikasi, nomor versi, 
 * serta navigasi ke media sosial/komunitas untuk dukungan pengguna.
 */
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen bg-linear-to-b from-surface-tint to-accent-soft">
      {/* Header Halaman Utama dengan tombol Back */}
      <StickyHeader
      ...
      <main className="flex-1 px-6 pt-12 pb-32 flex flex-col items-center">
        {/* Logo CardToo berbayang lembut dalam box putih */}
        ...
        {/* Daftar tombol tautan Sosial & Website */}
...
/**
 * Komponen Tombol Tautan Sosial Media (SocialButton)
 * Mengalihkan user ke tab browser baru (target="_blank") saat ditekan.
 * 
 * @param icon Ikon SVG visual di sisi kiri
 * @param label Nama media sosial (misal: Instagram)
 * @param value Teks detail username/link (misal: @cardtoo.official)
 * @param href URL tujuan media sosial
 */
