  ...
  return (
    <div className="flex flex-col min-h-screen bg-linear-to-b from-surface-tint to-accent-soft">
      ...
      <main className="flex-1 px-6 pt-6 pb-32">
        <div className="bg-white rounded-card p-8 shadow-soft border border-surface-muted">
          <div className="max-w-none text-text-sub leading-relaxed">
            <h2 className="text-[18px] font-bold text-text-main mb-4">1. Informasi yang Kami Kumpulkan</h2>
            <p className="mb-6">
            ...
            <h2 className="text-[18px] font-bold text-text-main mb-4">2. Penggunaan Informasi</h2>
            <p className="mb-6">
            ...
            <h2 className="text-[18px] font-bold text-text-main mb-4">3. Keamanan Data</h2>
            <p className="mb-6">
            ...
            <h2 className="text-[18px] font-bold text-text-main mb-4">4. Cookie</h2>
            <p className="mb-6">
